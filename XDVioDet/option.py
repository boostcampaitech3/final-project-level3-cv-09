...
parser.add_argument('--test-rgb-list', default='list/xx_rgb_test.list', help='list of test rgb features ')
parser.add_argument('--test-flow-list', default='list/xx_flow_test.list', help='list of test flow features')
parser.add_argument('--test-audio-list', default='list/xx_audio_test.list', help='list of test audio features')
