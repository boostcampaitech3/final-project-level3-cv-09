...
from yolo_utils.general import (CONFIG_DIR, FONT, LOGGER, Timeout, check_font, check_requirements, clip_coords,
...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='Arial.ttf', pil=False, example='abc'):
        ...
        self.png_bubble = cv2.imread("data/alter_images/bubble.png", cv2.IMREAD_UNCHANGED)
        if self.pil:  # use PIL
