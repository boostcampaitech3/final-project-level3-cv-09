...
# Import utilites
from ViolenceDetectionAndLocalization.local_utils import label_map_util
...
def violence_localization(threshold):
    frameno=0
        ...
        for frame_num in violent_scene:
            ...
            if frame is not None:
                ...
                for box in boxes[0]:
                    ...
                    y2 = int(y2*h)
                    ksize = 25
                    blur_img = frame[y1:y2, x1:x2].copy()
                    frame[y1:y2, x1:x2] = cv2.blur(blur_img, (ksize,ksize))
